...
#pragma config(Motor,  port6,           TowerLeft,     tmotorVex393_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port7,           TowerRight,    tmotorVex393_MC29, openLoop, driveRight)
...
void manipulator_tower(int time, int power) {
	motor[TowerLeft] = power;
	motor[TowerRight] = power;
	wait1Msec(time);
}
